...
%==============================================================================
    ...
    \section{Introduction}\label{sec:introduction}
        ...
        Q-learning and CSP model checking using DFS are two very different 
        ...
        One of the key differences between Q-learning and model checking is 
    ...
    \section{Results}\label{sec:results}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[scale=0.43]{assets/TimeAndSteps.png}
            \caption{captionTODO}
            \label{TimeAndSteps}
        \end{figure}

         It can be seen from this figure that, when it successfully found a 
         path, reinforcement learning was much quicker than CSP, following a 
         time trend closer to O(n). CSP, on the other hand, followed a 
         polynomial curve, somewhat following the $O(n^2)$ line on the graph.

        \begin{figure}[h]
            \centering
            \includegraphics[scale=0.43]{assets/StepsOnly.png}
            \caption{caption TODO}
            \label{StepsOnly}
        \end{figure}

         When the number of steps in the found path is shown on its own, 
         ...
         It is suspected here that Q-learning often failed to find the goal 
         ...
         Different configurations of starting values were tested to try 
        ...
        \begin{figure}[ht]
            \centering
            \includegraphics[scale=0.43]{assets/MemOnly.png}
            \caption{caption TODO}
            \label{MemOnly}
        \end{figure}

         This graph shows the difference in memory usage between RL and CSP. 
    ...
    \section{Conclusion}\label{sec:conclusion}
        ...
        In testing for this report, it is clear that Q-learning does not 
        ...
        It is advised that this be the subject of further study. By modifying 
        the Q-learning algorithm to incentivise leaving dead-end paths 
        (perhaps by imposing a penalty for repeatedly entering the same 
        states, or a reward for finding new states), it may be possible to 
        better tailor the algorithm to this problem, allowing it to be as
